      ...
      <div className='contact-container'>
        <div className='contact-options'>
          <article className='contact-option'>
            ...
            <a href='mailto:tadessejemal63@gmail.com'target='_blank'>Send a message</a>
          </article>
          <article className='contact-option'>
            <FaFacebookMessenger className='contact-option-icon' />
            <h4>Messager</h4>
            <h5>Tadesse Jemal</h5>
            <a href='https://m.me/tadesse.jemal.1/' target='_blank'>Send a message</a>
          </article>
          <article className='contact-option'>
            <IoLogoWhatsapp className='contact-option-icon' />
            <h4>WhatsApp</h4>
            <h5>+251918042280</h5>
            <a href='https://api.whatsapp.com/send?phone+251918042280' target='_blank'>Send a message</a>
          </article>
        </div>
